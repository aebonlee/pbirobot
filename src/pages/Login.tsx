...
const Login = (): ReactElement | null => {
  ...
  useEffect(() => {
    ...
    if (errorCode) {
      setError(errorDesc || `Login error: ${errorCode}`);
      ...
      <div className="auth-center-wrapper">
        <div className="auth-card-google">
          <div className="auth-logo-area">
            <span style={{ color: 'var(--primary-blue)', fontWeight: 700 }}>PBI</span>{' '}
            <span style={{ color: 'var(--text-primary)', fontWeight: 700 }}>Robot</span>
          </div>
